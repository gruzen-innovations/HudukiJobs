                     ...
                     <div class="card-body">
                        ...
                        <div class="col-md-12 col-lg-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-header"><strong>Add Locations</strong></div>

                                <div class="card-body card-block"> 

                                    {!! Form::open(['method' => 'POST', 'url' => 'store-height', 'enctype' => 'multipart/form-data']) !!}
                                        ...
                                        <div class="card-footer col-md-12">  
                                            ...
                                            <button type="button" class="btn btn-info btn-sm"><i class="fa fa-times-circle-o" aria-hidden="true"></i> <a href="{{url('height')}}">Cancel</a></button> 
