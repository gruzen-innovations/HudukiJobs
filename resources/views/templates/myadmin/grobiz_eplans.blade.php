                                ...
                                @php $i++; @endphp
                                  <tr>
                                      ...
                                      <td>
                                          ...
                                          <a onclick="return confirm('Are You Sure to delete selected data?')" href="{{url('delete-ecomm-plans')}}/{{$offer->id}}" class="btn btn-danger" title="" data-toggle="tooltip" data-original-title="Delete"><i class="fa fa-close"></i></a>
                                      </td>
                                  </tr>
                              @endforeach
                            @endif  
