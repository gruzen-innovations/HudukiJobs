                    ...
                    <div class="card-body">
                        ...
                        <div class="col-md-12 col-lg-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-header"><strong>Edit Locations</strong></div>

                                <div class="card-body card-block"> 

                                    {!! Form::open(['method' => 'POST', 'url' => 'update-height', 'enctype' => 'multipart/form-data']) !!}
                                    @csrf 
